...
const FALLBACK_HOME_DATA: Omit<HomePageData, "services" | "cityCoverage"> & {
  ...
  hero: {
    ...
    heading: "Trusted Doorstep Car & Bike Mechanic Service in Bangalore, Chennai, Hyderabad & Mumbai",
    subheading: "Stuck with a bike that won’t start? Car battery dead in your apartment parking? Our local mechanics come directly to your home, office, or roadside location for fast car and bike repair services. Available 24/7 for breakdown help, emergency repairs, periodic servicing, battery jumpstart, puncture repair, oil change, and more.",
