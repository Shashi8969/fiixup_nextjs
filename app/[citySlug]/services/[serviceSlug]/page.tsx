...
export default async function Page({
      ...
      <>
        <section className={`py-16 bg-gradient-to-br ${theme.gradient}`}>
          <div className="container mx-auto px-4 text-center">
            ...
            <div className="flex flex-wrap gap-4 justify-center">
              <Link href="/contact#contact-form" className={`${theme.btn} text-white px-8 py-3 rounded-lg transition-colors font-semibold`}>
                Book a Service
              </Link>
              <a href={`tel:${MAIN_PHONE}`} className="bg-red-600 text-white px-8 py-3 rounded-lg hover:bg-red-700 transition-colors font-semibold flex items-center gap-2">
        ...
        <section className="py-16 bg-blue-600 text-white text-center">
          <div className="container mx-auto px-4">
            ...
            <p className="text-white mb-8 text-lg">Certified technicians come to you — at home, office, or anywhere your vehicle is parked.</p>
            <div className="flex flex-wrap gap-4 justify-center">
              <Link href="/contact#contact-form" className="bg-white text-blue-600 px-8 py-3 rounded-lg font-bold hover:bg-blue-50 transition-colors">Book Service Now</Link>
  ...
  return (
    <>
      ...
      {brands.length > 0 && (
        <BrandsGrid brands={brands} heading={`${isCar ? "Car" : "Bike"} Brands We Service`} subtext={`Our certified mechanics are trained to service all popular ${isCar ? "car" : "bike"} brands available in India.`} accentColor={accentColor} />
      )}
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4 max-w-3xl">
          <h2 className="text-2xl md:text-3xl font-bold text-center mb-2">{service.shortTitle} — Frequently Asked Questions</h2>
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid sm:grid-cols-3 gap-6">
              {related.map((s) => {
                ...
                return (
                  <a key={s.slug} href={`/services/${s.slug}`} className="bg-white p-6 border border-gray-200 rounded-2xl hover:shadow-lg hover:border-gray-300 transition-all">
