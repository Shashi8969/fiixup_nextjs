...
export function ServiceCardPrice({
  ...
  return (
    ...
    >
      ...
      <div className={`absolute bottom-4 right-8 flex items-center gap-1 text-sm font-bold opacity-0 translate-x-4 group-hover:opacity-100 group-hover:translate-x-0 transition-all duration-300 ${theme.linkText}`}>
